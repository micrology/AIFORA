...
;;  31 March 2023
;;
;; version 0.9 - first rough draft (code and interface have been updated from the unemployment game; information under the info tab still needs to be updated)
...
to go
  ...
  ;; *** COME BACK TO IMPROVE THIS *** CHANGE IT TO: If an applicant hasn't received any budget in this round, and if they had any categories where they had a score greater than or equal to 4 (not self-sufficient) then those and one other random category gets worse.
